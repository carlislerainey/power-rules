...
Latest version \href{http://www.carlislerainey.com/power-rules/power-rules.pdf}{here}.
%Get latest version \href{https://github.com/carlislerainey/power-rules/blob/main/power-rules.pdf}{from GitHub}.
%Pre-print DOI: \href{https://github.com/carlislerainey/power-rules/blob/main/power-rules.pdf}{from GitHub}
\end{center}
